...
class Command(BaseCommand):
    ...
    def updateELO(self, _id1, _id2, _winner_id):
        ...
        expected1 = self.compareRating(rating1,rating2)
        expected2 = self.compareRating(rating2,rating1)
    ...
    def find_starters(self,pbp,_year):
        starters={}
        exclude=[]
        n_start=0
    ...
    def most_probable_jumper(self,_starters):
        jumpers=[]
        for _p in _starters:
    ...
    def find_jumpers(self,jump_play,_starters,_year):
        ...
        if j1==j2:
            ...
            if sum([len(jumpers[_t]) for _t in jumpers])!=2:
                ...
                jumpers[team_to_be_found].append(self.most_probable_jumper(_starters[team_to_be_found]))
