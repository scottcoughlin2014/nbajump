...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        jumpers=[203500,1628389,200746,1628386,203507,1628384,1629028,1628963,203382,1629647,202687,1628396,1628418,203991,1628976,1626161,1629634,1628381,203076,202334,203476,203083,201142,203954,1629655,201188,203497,201933,1629637,1626158,201143,2730,201586,1629640,203999,201599,202683,203458,1626172,201572,201577,201580,203994,203486,1627751,204001,203939,1629675,1629011,1629676,1627734,203471,1629012,1628464,202684,1629308,1626157,1626167,202685,202696,1626174,203469,1627826,1630173,202326,1630214,1630164,203084,2199,203473,2200,101162,101161,201567,1627748,1626175,200794,202389,203457,203512,2585,202355,1626177,1626171,203210,1627863]
        ...
        if not Player.objects.filter(nba_id=1628455).exists():
            ...
            print('Added Isaiah Canaan (id: 1628455)')
        ...
        if not Player.objects.filter(nba_id=201956).exists():
            ...
            print('Added Isaiah Canaan (id: 201956)')
        ...
        if not Player.objects.filter(nba_id=203966).exists():
            ...
            print('Added Isaiah Canaan (id: 203966)')
